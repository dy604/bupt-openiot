package com.bupt.openiot.service.security.auth.jwt.extractor;

import com.bupt.openiot.conf.OpenIoTSecurityConfig;
...
public class JwtQueryTokenExtractor implements TokenExtractor {
    ...
    public String extract(HttpServletRequest request) {
        ...
        if (request.getParameterMap() != null && !request.getParameterMap().isEmpty()) {
            String[] tokenParamValue = request.getParameterMap().get(OpenIoTSecurityConfig.JWT_TOKEN_QUERY_PARAM);
